          ...
          <section class="hero"  style="margin-top: 8rem !important;">
                <div class="container">
                  ...
                  <div class="hero-content pb-5 text-center">
                    <h1 class="mb-5">No tienes acceso</h1>
                    <div class="row">   
                      ...
                      <div class="cart-body" style="background: #fff6e8 !important;">
                        <div v-for="item in detalles">
                          <div class="cart-item" >
                            ...
                            <div class="col-2 text-center">{{convertCurrency(item.detalle.producto.precio*item.detalle.cantidad)}}
                          ...
                          <div class="cart-item" >
                            ...
                            <div class="row"  v-if="item.reviews.length == 0">
                              ...
                              <div class="col-8 d-flex">
                                ...
                                <button class="btn btn-sm btn-primary" v-on:click="enviar_review(item.detalle.producto._id)">Enviar</button>
                              </div>
                            </div>
                          </div>
                        </div>

    ...
    <section class="hero" style="margin-top: 8rem !important;">
      <div class="container">
        ...
        <div class="hero-content pb-2 text-center">
          <h1 class="hero-heading">Pizzas</h1>
          <!--<div class="row">
      ...
      <div class="row">
        ...
        <div class="products-grid col-xl-9 col-lg-8 order-lg-2">
          <header class="product-grid-header">
            <div class="me-3 mb-3">
               Mostrando <strong>{{currentPage}}-<span v-if="currentPage*perPage>productos.length">{{productos.length}}</span>
    ...
    beforeMount(){
        axios.get(this.$url+'/obtener_productos_shop',{
            ...
            if(this.$route.query.subcategoria){
              this.initProductoSubcategoria();
            }

            if(this.$route.query.categoria){
              this.initProductoCategoria();
            }

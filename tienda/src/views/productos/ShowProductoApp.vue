    ...
    <div class="pb-5">
        ...
        <div class="container">
            ...
            <div class="col-lg-5 ps-lg-4 order-1 order-lg-2">
                ...
                <span class="text-danger" v-if="nsm_error">{{ nsm_error }}</span>
            </div>
            </div>
        </div>
        </section>
            ...
            <div class="tab-pane active" id="additional-information" role="tabpanel">
                ...
                <div class="col-lg-6">
                    ...
                    <tbody>
                        ...
                        <td class="text-muted border-0" v-if="producto.titulo" :title="producto.titulo">{{producto.titulo}}</td>
                        </tr>
                        <tr>
                        <th class="text-uppercase fw-normal "><b>Categoría</b></th>
                        <td class="text-muted ">{{producto.categoria}}</td>
                        </tr>
                        <tr>
                        <th class="text-uppercase fw-normal "><b>Subcategoría</b></th>
    ...
    methods:{
        ...
        add_cart(){
            if(!this.obj_carrito.variedad){
                this.nsm_error='seleccione la variedad';
            }else if(!this.obj_carrito.cantidad){
                this.nsm_error='Ingrese la cantidad';
            }else if(this.obj_carrito.cantidad <= 0){
                this.nsm_error='Ingrese una cantidad valida';
            }else{
                this.nsm_error = '';

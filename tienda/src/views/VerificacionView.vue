    ...
    <div>
        <section class="hero" v-if="estado == 'pending' || estado =='failure'"  style="margin-top: 8rem !important;">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-8 offset-xl-2"><p class="lead mb-0">As am hastily invited settled at limited civilly fortune me. Really spring in extent an by. Judge but built party world. Of so am he remember although required. Bachelor unpacked be advanced at. 
                    Confined in declared marianne is vicinity. </p></div>
                </div>
                </div>
            </div>
        </section>
        <section class="hero" v-if="estado == 'success' "  style="margin-top: 8rem !important;">
            <div class="container" v-if="!msm_error">
                ...
                <div class="row">
                    <div class="col-xl-8 offset-xl-2">
                        <img src="/assets/media/tiempo.gif" style="width: 80px;">
                    </div>
                </div>
                </div>
            </div>
            <div class="container" v-if="msm_error">
                ...
                <div class="row">
                    <div class="col-xl-8 offset-xl-2"><p class="lead mb-0">Poner texto de guia al cliente </p></div>
                </div>
                </div>
            </div>
        </section>
...
export default {
    ...
    beforeMount(){
        ...
        if(this.$route.params.direccion){
            ...
            this.msm_error = 'No se pudo obtener el codigo de la dirección';
        }
        ...
        validad_venta(payment_id){
            ...
            headers:{
                ...
                if(result.data.length >= 1){
                    this.msm_error = 'El pago ya esta asignado a una venta';
        ...
        init_payment(payment_id){
            axios.get('https://api.mercadopago.com/v1/payments/'+payment_id,{
                ...
                if(this.pago.status == 'approved'){
                    this.validad_venta(this.payment_id);
                }else{
                    this.msm_error = 'el pago no fue aprovado';
                }
            })
        }
    }

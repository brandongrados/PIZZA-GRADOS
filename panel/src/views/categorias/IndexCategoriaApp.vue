                                ...
                                <div class="col-12">
                                    <ul class="list-group mt-3">
                                        <li v-for="subitem in item.subcategorias" class="list-group-item d-flex justify-content-between align-items-center" style="font-size: .8rem;padding: 0.5rem 1.5rem;">
                                            {{subitem.titulo }}
                                            ({{item.nproductosc}} Productos)<!--este cod lo agregué opcional-->
    ...
    methods:{
        crear_categoria(){
            if(this.nueva_categoria){
                ...
                axios
                .post(this.$url + "/crear_categoria_admin",{titulo: this.nueva_categoria}, {
                headers: {
        ...
        setTimeout(() => {
         ...
         crear_subcategoria(){
            if(this.nueva_subcategoria){
                axios
            .post(this.$url + "/crear_subcategoria_admin",
            {
            ...
            if(result.data.message){
                ...
                this.$notify({
                    group: "foo",
                    title: "ERROR",
                    text: 'Ingrese el título de la subcategoría',
                    type: "error",
                    });
            }
        ...
        eliminar_subcategoria(id){
            axios
            .delete(
            this.$url + "/eliminar_subcategoria_admin/" + id,
            {
                headers: {
                "Content-Type": "application/json",
        ...
        cambiar_estado(id,estado){
            axios
            .put(
            this.$url + "/cambiar_estado_producto_admin/" + id,
            { estado: estado },
            {
                headers: {
                "Content-Type": "application/json",

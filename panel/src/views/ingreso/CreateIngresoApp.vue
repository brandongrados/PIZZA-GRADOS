                ...
                <div class="row align-items-center">
                  <div class="col">
                    ...
                    <ul class="nav nav-tabs nav-overflow header-tabs">
                      <li class="nav-item">
                        <router-link class="nav-link" to="/ingreso"> Ingresos </router-link>
                      </li>
                      <li class="nav-item">
              ...
              <div class="col-12 col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input
                    type="file"
                    class="form-control"
                    v-on:change="uploadComprobante($event)"
                  />
                </div>
              </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="form-group">
                  ...
                  <select class="form-select mb-3" v-model="detalle.variedad">
                    ...
                    <option :value="item._id" v-for="item in variedades">
                      {{ item.variedad.toUpperCase() }} - {{ item.sku }} -
                      {{ item.stock }}
                    </option>
                  </select>
                </div>
              ...
              <div class="col-md-12">
                <button
                  ...
                  style="margin-bottom: 1.8rem !important"
                    ...
                    <tr>
                      <td class="text-center" colspan="5">
                        <span class="text-muted"
                          >No hay detalles en el ingreso</span
                        >
                      </td>
                    </tr>
                  </tbody>
...
export default {
  ...
  methods: {
    ...
    init_productos() {
      this.productos = [];
      axios
        .get(this.$url + "/listar_activos_productos_admin", {
          headers: {
    ...
    init_variedades(id) {
      axios
        .get(this.$url + "/obtener_variedades_producto/" + id, {
          headers: {
            "Content-Type": "application/json",
            Authorization: this.$store.state.token,
          },
    ...
    registro_ingreso() {
      if (!this.ingreso.proveedor) {
        ...
        axios
          .post(this.$url + "/registro_ingreso_admin", fm, {
            headers: {
